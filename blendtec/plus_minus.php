<i class="recipe-email-signup--icon-close svg">
	...
	<polygon id="plus" fill="none" points="827.7,472.4 552,472.4 552,196.7 473.2,196.7 473.2,472.4 197.5,472.4 197.5,551.1 
		473.2,551.1 473.2,826.8 552,826.8 552,551.1 827.7,551.1 "/>
	...
	455.9,511.7 261,706.7 316.7,762.4 511.6,567.4 706.6,762.4 "/>
	</svg>
